...
//	}
	...
	public void LoggingAdviceGetters() {
		System.out.println("Logging Advice After Getter");
		
	}
	@AfterReturning("execution(public * set*(..))")
	public void LoggingAdviceSetters() {
		System.out.println("Logging Advice After Setter");
		
	}
	
	@AfterThrowing("execution(public * throwExceptionDemo*())")
	public void LoggingAdviceExceptionDemo() {
		System.out.println("Logging Advice After Exception");
		
	}
	
	@Around("execution(public * getName*(..))")
	public String LoggingAdviceAroundAllGetters(ProceedingJoinPoint joinPoint) throws Throwable{
		String res;
	System.out.println("\nInside LoggingAspect : ");
		System.out.println(joinPoint.getSignature().getName() + "() : Before Method Execution");
		try {
           res=  (String) joinPoint.proceed();
        } finally {
