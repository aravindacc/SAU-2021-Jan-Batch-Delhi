...
// IMPORTANT-      Have only improved for import statement and constants, because rest of the code somewhat seems vague and not connected
...
import {initialStartIndex, debugPagination, noteListSize} from './constants'


/* useNoteListSubscribedHomeParentNoteList - useNoteListSubscribedToParentNoteListInTheHomeViewOfTheWebApp */
export const useNoteListSubscribedHomeParentNoteList = (filters, sort, disablePagination, skip: boolean = false) => {
