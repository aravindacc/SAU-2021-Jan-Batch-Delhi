...
public class Assignment
{
	public static void main(String[] args)
	{
		...
		{
			//Importing xml files
			File temp1 = new File("C:\\Users\\Muskaan\\eclipse-workspace\\AdvancedJava\\src\\advancedJava\\Input1.xml");
	        File temp2 = new File("C:\\Users\\Muskaan\\eclipse-workspace\\AdvancedJava\\src\\advancedJava\\Input2.xml");
	        ...
	        for (int i = 0; i < document1.getLength(); i++)
	        {
	            ...
	            for (int j = 0; j < licenseList.getLength(); j++)
	            {
	                ...
	                if (expiry.compareTo(now) > 0)
	                {
	                    ...
	                    print(validFile, "C:\\Users\\Muskaan\\eclipse-workspace\\AdvancedJava\\src\\advancedJava\\valid.txt");
	                    } 
	                ...
	                else
	                {
	                    ...
	                    print(invalidFile, "C:\\Users\\Muskaan\\eclipse-workspace\\AdvancedJava\\src\\advancedJava\\invalid.txt");
	                    }
	                }
	            }
	                	...
	                	for(int j = 0 ; j < list1.getLength() ; j++)
	                	{
	                        ...
	                        for(int k = 0 ; k < list2.getLength() ; k++)
	                        {
	                                ...
	                                && licenseElement1.getAttribute("License_Expiration_Date").equals(licenseElement2.getAttribute("License_Expiration_Date")))
	                        	{
	                                ...
	                                print(mergeFile,"C:\\Users\\Muskaan\\eclipse-workspace\\AdvancedJava\\src\\advancedJava\\merge.txt");
	                                }
	                        	}
	                        }
	                   }
