...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.jatin.assignment.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/SoapWebServiceAssignment/services/Calculator";
    ...
    public com.jatin.assignment.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.jatin.assignment.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jatin.assignment.CalculatorSoapBindingStub _stub = new com.jatin.assignment.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jatin.assignment.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jatin.assignment.CalculatorSoapBindingStub _stub = new com.jatin.assignment.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://assignment.jatin.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://assignment.jatin.com", "Calculator"));
        }
