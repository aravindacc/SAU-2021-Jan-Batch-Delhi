...
public class Main {
    ...
    public static void mergenodes(NodeList first,NodeList second,String Key)
    {
        ...
        for(int i=0;i<first.getLength();i++)
        {
            ...
            validInvalid(currEl.getElementsByTagName("License"));
        }
    ...
    private static void validInvalid(NodeList firstNode)
    {
    ...
    public static void main(String[] args) {
        try
        {
            ...
            NodeList list2=doc.getElementsByTagName("CSR_Producer");
            NodeList list1=doc2.getElementsByTagName("CSR_Producer");
           ...
           mergenodes(list1,list2,"NIPR_Number");
            ...
            DOMSource validdomsrc = new DOMSource(validDocument);
            StreamResult validResult = new StreamResult(new File("valid.xml"));
            transformer.transform(validdomsrc, validResult);


            DOMSource invaliddomsrc = new DOMSource(invalidDocument);
            StreamResult invalidResult = new StreamResult(new File("invalid.xml"));
            transformer.transform(invaliddomsrc, invalidResult);
