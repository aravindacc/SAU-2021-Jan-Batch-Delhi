...
public class SeniorDeveloper implements EmployeeDetails{
    ...
    public SeniorDeveloper(int id,String name,String Email,long PhoneNumber,double salary,String notifyMode) {  
     this.id=id;      
     this.name = name;  
     this.Email=Email;
