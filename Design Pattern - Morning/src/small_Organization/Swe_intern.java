...
public class Swe_intern implements Employee{
	 private int empId;
     private String name; 
     ...
     public Swe_intern(int empId,String name,String Email,String address,long PhoneNumber,double salary,String notifyMode) {  
         this.empId=empId;      
         this.name = name;  
         this.Email=Email;
